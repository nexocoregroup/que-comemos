...
proyecto ejecuta una pantalla en un navegador. Que las 656 pasen dice que la
...
| Qué | Cómo | Notas |
|---|---|---|
| Pruebas | `npm test` | 656, unos 16 s. El número crece; si no cuadra, manda `npm test`, no esta tabla. Sin argumentos: `node --test tests/` con la carpeta como argumento **no** funciona |
