...
proyecto ejecuta una pantalla en un navegador. Que las 670 pasen dice que la
...
| Qué | Cómo | Notas |
|---|---|---|
| Pruebas | `npm test` | 670, unos 16 s. El número crece; si no cuadra, manda `npm test`, no esta tabla. Sin argumentos: `node --test tests/` con la carpeta como argumento **no** funciona |
